...
import AIImageGeneratorPanel from '@/components/editor/image-generators/AIImageGeneratorPanel.vue'
...
import AIDialogPanel from '@/components/editor/AIDialogPanel.vue'
...
<template>
  ...
  <AIDialogPanel v-model:open="uiStore.aiDialogVisible" />
